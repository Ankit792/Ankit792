...
class poseDetector():
    ...
    def __init__(self, mode=False, complex=1, smooth=True, enable=False, smoothSeg=True, detectionCon=0.5,
                 trackCon=0.5):
        self.mode = mode
        ...
        self.pose = self.mpPose.Pose(self.mode, self.complex, self.smooth, self.enable, self.smoothSeg,
